...
export const translations = {
	...
	id: {
		...
		contact: {
			...
			messageLabel: 'Pesan',
			messagePlaceholder: 'Halo Fachry, mau ngobrol tentang...',
			sendButton: 'Kirim Pesan',
			sending: 'Mengirim...',
			successMessage: 'Pesan terkirim! Terima kasih sudah menyapa, saya akan segera membalasnya secepatnya.',
			errorMessage: 'Gagal mengirim pesan. Silakan coba lagi atau langsung hubungi lewat email ya.'
		},
		footer: {
