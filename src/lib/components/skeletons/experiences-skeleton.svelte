	...
	<div class="mx-auto h-fit w-full px-6 sm:px-10 md:px-16 lg:px-28">
		...
		<div class="mt-8">
			{#each Array(skeletonRows) as _, i}
				...
				<div
					class="border-border skeleton-card mb-3 cursor-pointer overflow-hidden rounded-xl border"
					...
					<div class="bg-background w-full cursor-pointer px-3 py-2 text-left sm:px-4 sm:py-3">
							...
							<div class="flex items-center justify-between">
								<div class="flex-grow">
									<div class="flex items-center gap-2">
										...
										<div class="bg-foreground/10 animate-pulse rounded-full px-2 py-0.5">
											<div class="bg-accent-foreground/20 h-4 w-20 rounded"></div>
										</div>
									</div>

									<div class="mt-1 flex items-center gap-2">
										<div class="bg-foreground/15 h-4 w-32 animate-pulse rounded"></div>
										<div class="bg-foreground/10 h-3 w-1 animate-pulse rounded"></div>
										<div class="bg-foreground/10 h-4 w-24 animate-pulse rounded"></div>
									</div>
								</div>
								<div class="ml-4 flex flex-col items-end">
									<div class="bg-foreground/12 mb-1 h-4 w-28 animate-pulse rounded"></div>
									{#if !isExpanded}
										<div class="flex flex-wrap justify-end gap-1">
											<div
												class="bg-secondary h-5 w-12 animate-pulse rounded-full"
											></div>
											<div
												class="bg-secondary h-5 w-16 animate-pulse rounded-full"
												style="animation-delay: 0.1s"
											></div>
											<div
												class="bg-secondary h-5 w-8 animate-pulse rounded-full"
						...
						<div class="block sm:hidden">
							<div class="mb-2">
								...
								<div class="bg-foreground/10 mt-1 inline-block rounded-full px-2 py-0.5">
									<div class="bg-accent-foreground/20 h-3 w-12 animate-pulse rounded"></div>
								</div>
							</div>
							<div class="mb-2">
								<div class="bg-foreground/15 mb-1 h-3 w-1/2 animate-pulse rounded"></div>
								<div class="bg-foreground/10 mb-1 h-3 w-1/3 animate-pulse rounded"></div>
								<div class="bg-foreground/12 h-3 w-1/4 animate-pulse rounded"></div>
							</div>
							{#if !isExpanded}
						...
						<div class="hidden sm:block md:hidden">
							<div class="flex items-start justify-between">
								<div class="flex-grow pr-3">
									...
									<div class="bg-foreground/15 mb-1 h-4 w-1/2 animate-pulse rounded"></div>
									<div class="bg-foreground/10 h-3 w-1/3 animate-pulse rounded"></div>
								</div>
								<div class="flex flex-col items-end">
									<div class="bg-foreground/12 mb-2 h-4 w-24 animate-pulse rounded"></div>
									{#if !isExpanded}
										<div class="flex flex-wrap justify-end gap-1">
											<div
												class="bg-secondary h-5 w-12 animate-pulse rounded-full"
