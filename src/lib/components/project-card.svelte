		...
		<div class="space-y-4">
			...
			<div class="border-border/50 flex items-center gap-3 border-t pt-4">
				<a
					...
					class="bg-primary text-primary-foreground hover:bg-primary/90 flex-1 rounded-lg px-4 py-2 text-center text-sm font-medium transition-colors"
				>
					Read Story
				</a>
				{#if project.liveUrl}
					<a
						...
						class="bg-secondary/80 hover:bg-secondary border-border/50 rounded-lg border p-2 transition-colors"
